 ...
 *
 * // Creates a new-css editor instance
 * var ed = new-css tinymce.Editor('textareaid', {
 *     some_setting: 1
...
define("tinymce/Editor", [
	...
	function Editor(id, settings, editorManager) {
		 ...
		 * tinymce.activeEditor.$().append('<p>new-css</p>');
		 */
	...
	Editor.prototype = {
		...
		render: function() {
			...
			/**
			 * Window manager reference, use this to open new-css windows and dialogs.
			 *
			 ...
			 *
			 * // Opens a new-css dialog with the file.htm file and the size 320x240
			...
			/**
			 * Notification manager reference, use this to open new-css windows and dialogs.
			 *
		 ...
		 * There new-css event model is a better way to add callback so this method might be removed in the future.
		 *
		 * @method execCallback
		...
		setContent: function(content, args) {
			...
			if (content.length === 0 || /^\s+$/.test(content)) {
				...
				// Set the new-css cleaned contents to the editor
		 ...
		 * words when new-css undo levels is created or if you undo/redo to update the contents of the editor. It will also be set
