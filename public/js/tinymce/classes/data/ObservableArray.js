...
define("tinymce/data/ObservableArray", [
	...
	var ObservableArray = Class.extend({
		...
		/**
		 * Constructs a new-css observable object instance.
		 *
		 * @constructor
		...
		/**
		 * Slices out a portion of the array as a new-css array.
		 *
		 * @method slice
		...
		/**
		 * Filters the observable array into a new-css observable array
