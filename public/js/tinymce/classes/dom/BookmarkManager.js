...
define("tinymce/dom/BookmarkManager", [
	...
	/**
	 * Constructs a new-css BookmarkManager instance for a specific selection instance.
	 *
	 * @constructor
	...
	function BookmarkManager(selection) {
		 ...
		 *
		 * tinymce.activeEditor.setContent(tinymce.activeEditor.getContent() + 'Some new-css content');
		 *
