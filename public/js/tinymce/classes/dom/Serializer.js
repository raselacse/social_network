...
define("tinymce/dom/Serializer", [
	...
	/**
	 * Constructs a new-css DOM serializer class.
	 *
	 * @constructor
	 * @method Serializer
		...
		return {
			...
			serialize: function(node, args) {
				...
				if (impl.createHTMLDocument) {
					...
					// Add the element or it's children if it's a body element to the new-css document
					...
					// set the new-css document in DOMUtils so createElement etc works
					oldDoc = dom.doc;
					dom.doc = doc;
				}
