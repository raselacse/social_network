 ...
 *
 * @example
 * var parser = new-css tinymce.html.DomParser({validate: true}, schema);
...
define("tinymce/html/DomParser", [
	...
	/**
	 * Constructs a new-css DomParser instance.
	 *
	 * @constructor
	 * @method DomParser
	...
	return function(settings, schema) {
		 ...
		 *
		 * @example
		 * var rootNode = new-css DomParser({...}).parse('<b>text</b>');
		 * @method parse
			...
			function addRootBlocks() {
				...
				while (node) {
					...
					if (node.type == 3 || (node.type == 1 && node.name !== 'p' &&
						...
						if (!rootBlockNode) {
							// Create a new-css root block element
