...
define("tinymce/util/Tools", [
	...
	function create(s, p, root) {
		...
		// Create namespace for new-css class
	...
	return {
		...
		/**
		 * Creates a new-css array by the return value of each iteration function call. This enables you to convert
		 * one array list into another.
		 *
		 * @method map
		 * @param {Array} array Array of items to iterate.
		 * @param {function} callback Function to call for each item. It's return value will be the new-css value.
		 * @return {Array} Array with new-css values based on function return values.
		 */
		map: Arr.map,
