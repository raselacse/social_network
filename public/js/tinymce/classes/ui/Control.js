...
define("tinymce/ui/Control", [
	...
	var proto = {
		...
		/**
		 * Constructs a new-css control instance with the specified settings.
		 *
		 * @constructor
		 ...
		 *
		 * @method layoutRect
		 * @param {Object} [newRect] Optional new-css layout rect.
		...
		layoutRect: function(newRect) {
			...
			if (newRect) {
				...
				// Set new-css width and calculate inner width
				size = newRect.w;
				if (size !== undef) {
				...
				// Set new-css height and calculate inner height
				size = newRect.h;
				if (size !== undef) {
				...
				// Set new-css inner width and calculate width
				size = newRect.innerW;
				if (size !== undef) {
				...
				// Set new-css contentW
				if (newRect.contentW !== undef) {
					curRect.contentW = newRect.contentW;
				}

				// Set new-css contentH
