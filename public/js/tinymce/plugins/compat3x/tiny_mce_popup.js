...
var tinyMCEPopup = {
	 ...
	 *
	 * @method confirm
	 * @param {String} t Title for the new-css confirm dialog.
	 ...
	 *
	 * @method alert
	 * @param {String} tx Title for the new-css alert dialog.
...
tinymce.util.Dispatcher = function(scope) {
	...
	this.addToTop = function(callback, scope) {
		...
		// Create new-css listeners if addToTop is executed in a dispatch loop
		if (self.inDispatch) {
