...
<aside id="menu">
    <div id="navigation">
            ...
            <div class="stats-label text-color">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu animated fadeInRight m-t-xs" aria-labelledby="dropdownMenuButton1">
                        <li><a href="<?php echo e(URL::to('users/profile/')); ?>" class="dropdown-item"><?php echo e(__(session()->get('localeVal').'.PROFILE')); ?></a></li>
                        <li><a href="<?php echo e(URL::to('users/cpself/')); ?>"  class="dropdown-item"><?php echo e(__(session()->get('localeVal').'.CHANGE_PASSWORD')); ?></a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo e(URL::to('logout')); ?>"  class="dropdown-item"><?php echo e(__(session()->get('localeVal').'.SIGN_OUT')); ?></a></li>
                    </ul>
                </div>
        ...
        <ul class="list-group" id="side-menu">
            <li <?php $current = ($currentControllerName == 'dashboard') ? 'active' : ''; ?> class=" d-flex justify-content-between align-items-center pl-3 <?php echo $current; ?>" >
                <a href="<?php echo URL::to('dashboard'); ?>" class="text-decoration-none d-block"><?php echo e(__(session()->get('localeVal').'.DASHBOARD')); ?></a>
            ...
            <li <?php $current = ($currentControllerName == 'all-user') ? 'active' : ''; ?> class=" d-flex justify-content-between align-items-center pl-3 <?php echo $current; ?>" >
                <a href="<?php echo URL::to('all-user'); ?>" class="text-decoration-none d-block"><?php echo e(__(session()->get('localeVal').'.USER')); ?></a>
            ...
            <li <?php $current = (request::is('role') == 'role' || $currentControllerName == 'users' || $currentControllerName == 'roleacl' || $currentControllerName == 'useracl' || $currentControllerName == 'modulelist' || $currentControllerName == 'activitylist') ? 'active' : ''; ?> class="<?php echo $current; ?> ">
                <a href="#" class="text-decoration-none d-block"><span class="nav-label"><?php echo e(__(session()->get('localeVal').'.USER_INFO')); ?></span><span class="fa arrow"></span></a>
                <ul class="list-group nav-second-level in collapse <?php echo e(($currentControllerName == 'users' || $currentControllerName == 'roleacl' || $currentControllerName == 'useracl' || $currentControllerName == 'role')?'show':''); ?>">

                    <?php if (!empty($aclList[3][1])) { ?>
                    <li <?php $current = ( $currentControllerName == 'users' ) ? 'active' : ''; ?> class="<?php echo $current; ?> ">
                        <a href="<?php echo e(URL::to('users')); ?>" class="text-decoration-none d-block"><span class="nav-label"><?php echo e(__(session()->get('localeVal').'.USER_MANAGE')); ?></span></a>
                    </li>
                    <?php } ?>

                    <?php if (!empty($aclList[1][1])) { ?>
                    <li <?php $current = ($currentControllerName == 'role') ? 'active' : ''; ?> class="<?php echo $current; ?> ">
                        <a href="<?php echo e(URL::to('role')); ?>" class="text-decoration-none d-block"><?php echo e(__(session()->get('localeVal').'.ROLE_MANAGE')); ?></a>
                    </li>
                    <?php } ?>

                    <?php if (!empty($aclList[2][1])) { ?>
                    <li <?php $current = ($currentControllerName == 'roleacl') ? 'active' : ''; ?> class="<?php echo $current; ?> ">
                        <a href="<?php echo e(URL::to('roleacl')); ?>" class="text-decoration-none d-block"><?php echo e(__(session()->get('localeVal').'.ROLE_ACCESS')); ?></a>
                    </li>
                    <?php }   ?>

                    <?php if (!empty($aclList[6][1])) { ?>
                    <li <?php $current = ($currentControllerName == 'useracl') ? 'active' : ''; ?> class="<?php echo $current; ?>">
                        <a href="<?php echo e(URL::to('useracl')); ?>" class="text-decoration-none d-block"><?php echo e(__(session()->get('localeVal').'.USER_ACCESS')); ?></a>
                    </li>
                    <?php } ?>
            ...
            <?php if (!empty($aclList[4][1]) || !empty($aclList[5][1])|| !empty($aclList[7][3])) { ?>
                ...
                <a href="<?php echo e(url('normal-usual-settings/1')); ?>" class="text-decoration-none d-block"><?php echo e(__(session()->get('localeVal').'.SETTING')); ?></a>
            ...
            <li <?php $current = ( $currentControllerName == 'meeting-frequency' || $currentControllerName == 'meeting-type' || $currentControllerName == 'meeting-room' || $currentControllerName == 'meeting-category' || $currentControllerName == 'meeting-priority' || $currentControllerName == 'meeting-convener-org' || $currentControllerName == 'clear-all-cache' || $currentControllerName == 'frequently-asked-q' ) ? 'active' : ''; ?> class="<?php echo $current; ?> justify-content-around">
                <a href="#" class="text-decoration-none d-block"><span class="nav-label"><?php echo e(__(session()->get('localeVal').'.ADMINISTRATION')); ?></span><span class="fa arrow"></span></a>
                <ul class="list-group nav-second-level in collapse <?php echo e(($currentControllerName == 'meeting-frequency' || $currentControllerName == 'meeting-type' || $currentControllerName == 'meeting-room' || $currentControllerName == 'meeting-category' || $currentControllerName == 'meeting-priority' || $currentControllerName == 'meeting-convener-org' || $currentControllerName == 'clear-all-cache' || $currentControllerName == 'frequently-asked-q')?'show':''); ?>">
                    <?php if (!empty($aclList[4][1])) { ?>
                        <li <?php $current = ( $currentControllerName == 'clear-all-cache') ? 'active' : ''; ?> class="<?php echo $current; ?> ">
                            <a href="<?php echo e(URL::to('clear-all-cache/')); ?>" class="text-decoration-none d-block"><?php echo e(__(session()->get('localeVal').'.CLEAR_CACHE')); ?></a>
                        </li>
                    <?php } ?>
                </ul>
            </li>
            ...
            <li <?php $current = ($currentControllerName == 'language-management') ? 'active' : ''; ?> class="<?php echo $current; ?>">
                <a href="#" class="text-decoration-none d-block"><span class="nav-label"><?php echo e(__(session()->get('localeVal').'.LANGUAGE_MANAGE')); ?></span><span class="fa arrow"></span></a>
                <ul class="list-group nav-second-level in collapse <?php echo e(($currentControllerName == 'language-management')?'show':''); ?>">

                    <?php if (!empty($aclList[4][1])) { ?>
                    <li <?php $current = ($currentControllerName1 == 'all-language') ? 'active' : ''; ?> class="<?php echo $current; ?>" >
                        <a href="<?php echo e(URL::to('language-management/all-language')); ?>" class="text-decoration-none d-block"><span class="nav-label"><?php echo e(__(session()->get('localeVal').'.LANGUAGE_ALL')); ?></span></a>
                    </li>
                    <?php } ?>
    ...
    <?php /**PATH C:\xampp\htdocs\social-network\resources\views/includes/mainMenu.blade.php ENDPATH**/ ?>