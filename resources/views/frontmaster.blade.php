...
<div class="col-lg-6">
								...
								<div class="central-meta item">
									<div class="user-post">
										<div class="friend-info">
											<figure>
												<img src="{{asset('frontend/images/resources/nearly6.jpg')}}" alt="">
											</figure>
											<div class="friend-name">
								...
								<div class="central-meta item">
									<div class="user-post">
										<div class="friend-info">
											<figure>
												<img alt="" src="{{asset('frontend/images/resources/friend-avatar10.jpg')}}">
											</figure>
											<div class="friend-name">
											...
											<div class="post-meta">
												<div class="linked-image align-left">
													<a title="" href="#"><img alt="" src="{{asset('frontend/images/resources/page1.jpg')}}"></a>
												</div>
												<div class="detail">
