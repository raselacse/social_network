    ...
    <div class="access-control-list">
        <table id="access_table" class="table table-striped table-bordered table-vcenter">
            <thead style="background-color: #fff; color: #000">
                <tr>
                    <th class="headcol" style="border-top: 1px solid #ddd; ">{!!trans('english.MODULE_NAME')!!}</th>
                    <?php
            ...
            <tbody>
                ...
                if (!empty($modules)) {
                    ...
                    <tr>
                        ...
                        <td colspan="<?php echo count($all_activity); ?>">
                            <div class="checkbox checkbox-success">
                                ...
                                <label for="activity_header" style="font-weight: bold;margin-bottom:15px;">{!!trans('english.UPDATE_EXIST_USERS')!!}</label>
                            </div>
                            <input type="hidden" name="role_id" value="<?php echo $role_id ?>" />
                            <!--<input type="submit" name="form_submit" value="Save" />-->
                            <div class="col-sm-8 col-sm-offset-0">
                                <?php //if (!empty($acllogArr[17][3])) { ?>
                                    <button class="btn btn-info" type="submit"><?php echo trans('english.SAVE'); ?></button>
                                <?php //} ?>
                                <a class="btn btn-default" href="{!! URL::to('roleacl') !!}">{!!trans('english.CANCEL')!!}</a>
                            </div>
                        </td>
                    </tr>
                    <?php
                    ...
                    echo '<tr>';
                    echo '<td colspan="5">' . trans("NO_DATA_FOUND") . '</td>';
                    echo '</tr>';
                }
                ?>
            </tbody>
